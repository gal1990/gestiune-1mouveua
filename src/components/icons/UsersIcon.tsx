const UsersIcon = (props) => {
    return (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            />
            <path
                d="M13.333 2.60828C14.05 2.79186 14.6855 3.20886 15.1394 3.79354C15.5932 4.37821 15.8395 5.0973 15.8395 5.83744C15.8395 6.57759 15.5932 7.29668 15.1394 7.88135C14.6855 8.46603 14.05 8.88303 13.333 9.06661"
                stroke="#6B7280"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
